...
export class AccountService {
  ...
  public async getReservations() {
    const reservationPromise = new Promise<IReservation[]>(async(resolve, reject) => {
      ...
      this.http.get<IReservation[]>(this.reservationApi + 'get', {headers: headers}).subscribe(res => {
        resolve(res);
      }, error => {
        reject();
      })
